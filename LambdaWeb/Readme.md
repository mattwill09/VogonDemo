...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *LambdaWeb*):
...
Execute unit tests
```
    cd "LambdaWeb/test/LambdaWeb.Tests"
    dotnet test
```

Deploy application
```
    cd "LambdaWeb/src/LambdaWeb"
